...
###### Steps to update Patroni and postgres config :

1. Update file vars/main.yml
2. Run `update_postgres_patroni_conf.yml` playbook 
3. run 'systemctl restart patroni' in each node
